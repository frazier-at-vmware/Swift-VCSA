//
// VcenterVmStoragePolicyVmHomePolicySpec.swift
//
...
public struct VcenterVmStoragePolicyVmHomePolicySpec: Codable {

    /** Policy type to be used while performing update operation on the virtual machine home&#39;s directory. */
    public var type: VcenterVmStoragePolicyVmHomePolicySpecPolicyType
    ...
    public init(type: VcenterVmStoragePolicyVmHomePolicySpecPolicyType, policy: String?) {
        self.type = type
        self.policy = policy
    }
