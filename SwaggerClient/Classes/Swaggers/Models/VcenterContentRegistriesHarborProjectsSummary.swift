//
// VcenterContentRegistriesHarborProjectsSummary.swift
//
...
public struct VcenterContentRegistriesHarborProjectsSummary: Codable {
    ...
    public init(project: String, name: String, scope: VcenterContentRegistriesHarborProjectsScope) {
