...
public struct VcenterDeploymentTask: Codable {

    /** The progress info of this deployment task. This field is optional and it is only relevant when the value of CommonInfo#status is one of RUNNING, BLOCKED, SUCCEEDED, or FAILED. */
    public var progress: CisTaskProgress?
    /** Result of the task. This field will be unset if result is not available at the current step of the task. */
