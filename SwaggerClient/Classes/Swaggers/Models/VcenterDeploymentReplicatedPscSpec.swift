//
// VcenterDeploymentReplicatedPscSpec.swift
//
...
public struct VcenterDeploymentReplicatedPscSpec: Codable {
    ...
    public init(ssoSiteName: String?, partnerHostname: String, httpsPort: Int64?, ssoAdminPassword: String, sslThumbprint: String?, sslVerify: Bool?) {
