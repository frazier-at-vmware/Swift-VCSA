//
// VcenterTrustedInfrastructureTrustAuthorityHostsKmsSummary.swift
//
...
public struct VcenterTrustedInfrastructureTrustAuthorityHostsKmsSummary: Codable {

    /** Defines the verbosity of the summary. */
    public var summaryType: VcenterTrustedInfrastructureTrustAuthorityHostsKmsSummaryType
    ...
    public init(summaryType: VcenterTrustedInfrastructureTrustAuthorityHostsKmsSummaryType, host: String?, address: VcenterTrustedInfrastructureNetworkAddress?, group: String?, cluster: String?, trustedCA: VcenterTrustedInfrastructureX509CertChain?) {
