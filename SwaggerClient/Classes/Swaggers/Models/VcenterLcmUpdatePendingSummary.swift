//
// VcenterLcmUpdatePendingSummary.swift
//
...
public struct VcenterLcmUpdatePendingSummary: Codable {
    ...
    public init(pendingUpdate: String, version: String, releaseDate: Date, severity: VcenterLcmUpdatePendingSeverityType, build: String, updateType: VcenterLcmUpdatePendingUpdateType, category: VcenterLcmUpdatePendingCategory, rebootRequired: Bool, executeURL: String, releaseNotes: [String]) {
