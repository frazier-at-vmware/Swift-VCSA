//
// VcenterVmGuestProcessesCreateSpec.swift
//
...
public struct VcenterVmGuestProcessesCreateSpec: Codable {
    ...
    public init(path: String, arguments: String?, workingDirectory: String?, environmentVariables: [String:String]?, startMinimized: Bool?) {
        self.path = path
