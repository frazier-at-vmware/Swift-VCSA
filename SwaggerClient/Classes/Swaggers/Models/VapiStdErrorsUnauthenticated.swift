//
// VapiStdErrorsUnauthenticated.swift
//
...
public struct VapiStdErrorsUnauthenticated: Codable {
    ...
    public init(challenge: String?, messages: [VapiStdLocalizableMessage], data: JSONValue?, errorType: VapiStdErrorsErrorType?) {
