//
// VcenterVmHardwareBootCreateSpec.swift
//
...
public struct VcenterVmHardwareBootCreateSpec: Codable {

    /** Firmware type to be used by the virtual machine. If unset, defaults to value that is recommended for the guest OS and is supported for the virtual hardware version. */
    ...
    /** Protocol to use when attempting to boot the virtual machine over the network. If unset, defaults to a system defined default value. */
