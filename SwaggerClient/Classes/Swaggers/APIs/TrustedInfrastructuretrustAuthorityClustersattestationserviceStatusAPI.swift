//
// TrustedInfrastructuretrustAuthorityClustersattestationserviceStatusAPI.swift
//
...
open class TrustedInfrastructuretrustAuthorityClustersattestationserviceStatusAPI {
    /**
    ...
    /**
     Return the Attestation service health in the given cluster.
     - GET /api/vcenter/trusted-infrastructure/trust-authority-clusters/{cluster}/attestation/service-status?vmw-task=true
     - API Key:
  ...
  "empty": true
    ...
    open class func gettaskWithRequestBuilder(cluster: String) -> RequestBuilder<String> {
        var path = "/api/vcenter/trusted-infrastructure/trust-authority-clusters/{cluster}/attestation/service-status?vmw-task=true"
