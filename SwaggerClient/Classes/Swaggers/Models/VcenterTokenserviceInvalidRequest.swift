//
// VcenterTokenserviceInvalidRequest.swift
//
...
public struct VcenterTokenserviceInvalidRequest: Codable {
    ...
    public init(messages: [VapiStdLocalizableMessage], data: JSONValue?) {
