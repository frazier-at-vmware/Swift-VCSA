//
// VcenterVmHardwareCdromUpdateSpec.swift
//
...
public struct VcenterVmHardwareCdromUpdateSpec: Codable {

    /** Physical resource backing for the virtual CD-ROM device.   This field may only be modified if the virtual machine is not powered on or the virtual CD-ROM device is not connected.  If unset, the value is unchanged. */
    ...
    public init(backing: VcenterVmHardwareCdromBackingSpec?, startConnected: Bool?, allowGuestControl: Bool?) {
